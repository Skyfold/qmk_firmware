...
[_NUM_SYM] = {
  ...
  {CTL_T(KC_BSLS),  KC_COLN, KC_1,    KC_2,    KC_3,   KC_AMPR, KC_GRV,        KC_LCBR,  KC_RCBR, KC_LBRC, KC_RBRC, MT(MOD_RSFT, KC_ENTER)},
  {XXXXXXX,         XXXXXXX, XXXXXXX, XXXXXXX, MOUSE,  KC_SPC,  CTL_T(KC_ESC), NUM_SYM,  XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX}
},
...
[_MOUSE] = {
  ...
  {CTL_T(KC_BSLS), XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, XXXXXXX, KC_BTN4, MT(MOD_RSFT, KC_ENTER)},
